<div class="container">	
	<h1 class="lead text-center">Edição de Pessoa</h1>
	<!-- multistep form -->
	<form id="msform" method="post" action="">
		...
		<fieldset>	
			...
			<p><input type="text" id="nome" name="nome" value="<?= $pessoa['nm_pessoa'] ?>" placeholder="Nome" required="required" autofocus class="form-control"
				data-validation="required"			
				data-validation-error-msg="Nome inválido." /></p>
				
			<label for="cpf" class="pull-left">Cpf:</label>
			<p><input type="text" id="cpf" name="cpf" value="<?= $pessoa['nr_cpf'] ?>" placeholder="Cpf" required="required" class="form-control"
				data-validation="required length"	
				data-validation-length="14" 				
				data-validation-error-msg="Cpf inválido" /></p>
				
			<label for="email" class="pull-left">Email:</label>
			<p><input id="email" name="email" value="<?= $pessoa['ds_email'] ?>" placeholder="Email" required="required" class="form-control"
				data-validation="required email"
				data-validation-error-msg="Email inválido" /></p>
			
			<label for="data" class="pull-left">Data de Nascimento:</label>
			<p><input type="text" id="data" name="data" value="<?= date('d/m/Y', strtotime($pessoa['dt_nascimento'])) ?>" placeholder="dd/mm/aaaa" required="required" class="form-control"
				data-validation="required length"
		...
		<div class="text-center">
			...
			<div class="col-md-3">
				...
				<p><input type="text" id="cep" name="cep" value="<?= $pessoa['nr_cep'] ?>" placeholder="CEP" required="required" class="form-control"
					data-validation="required length"
			...
			<div class="col-md-9">
				...
				<p><input type="text" id="logradouro" name="logradouro" value="<?= $pessoa['ds_logradouro'] ?>" placeholder="Logradouro" required="required" class="form-control"
					data-validation="required"
			...
			<div class="col-md-6">
				...
				<p><input type="text" id="complemento" name="complemento" value="<?= $pessoa['ds_complemento'] ?>" placeholder="Complemento" class="form-control" /></p>
			</div>
				
			<div class="col-md-6">
				<label for="numero" class="pull-left">Número:</label>
				<p><input type="text" id="numero" name="numero" value="<?= $pessoa['nr_logradouro'] ?>" placeholder="Número" class="form-control" /></p>
			</div>
			
			<div class="col-md-4">
				<label for="bairro" class="pull-left">Bairro:</label>
				<p><input type="text" id="bairro" name="bairro" value="<?= $pessoa['ds_bairro'] ?>" placeholder="Bairro" required="required" class="form-control"
					data-validation="required"
			...
			<div class="col-md-4">
				...
				<p><input type="text" id="cidade" name="cidade" value="<?= $pessoa['ds_cidade'] ?>" placeholder="Cidade" required="required" class="form-control"
					data-validation="required"
			...
			<div class="col-md-4">
				...
				<p><input type="text" id="estado" name="estado" value="<?= $pessoa['ds_estado'] ?>" placeholder="Estado" required="required" class="form-control"
					data-validation="required"
		...
		<fieldset>
			...
			<input type='hidden' value="<?= $pessoa['ds_habilidades'] ?>" />
			<p><input type="text" id="habilidades" name="habilidades" value="<?= $pessoa['ds_habilidades'] ?>" placeholder="Habilidades" class="form-control" 
				data-validation="required"
				data-validation-error-msg="Habilidade inválida" /></p>
			
			<label for="departamento" class='pull-left'>Departamento</label>
			<select id="departamento" name="departamento" class="form-control">
				<option value="<?= $pessoa['ds_departamento'] ?>">Depto <?= $pessoa['ds_departamento'] ?></option>
